...
wavelength = [1500, 1520, 1540, 1560, 1580, 1600]  # wavelengths [nm]

for wav_nm in wavelength:
    h_core = spec.H
    w_core = 1500         # [nm]
    t_box = spec.BOX_H
    nmodes = 5
    ...
    if len(neffs) >= 2:
        ...
        W_m = w_core * 1e-6
        L_pi_fund = (4 * n0 * W_m**2) / (3 * wav_nm * 1e-9)
...
save_dir = r"C:\Users\phill\OneDrive\Skole\Kandidat\1.Semester\Photonic Integrated Circuit Design\Projects\My Project\optical_couplers\simulation_data\MMI_COUPLER_data_wav_num"
os.makedirs(save_dir, exist_ok=True)

# Save CSV file
save_path = os.path.join(save_dir, "MMI_3dB_results_wavelength_dependence.csv")
